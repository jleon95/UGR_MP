...
@param grados    A elegir entre 90, 180 ó 270.
@param sentidoHorario    La dirección de rotación.  
*/
...
Libera la memoria del vector dinámico asociado al objeto que llama al método y pone el puntero a 0.
*/
   void destruir();

/// Rota una imagen 90º en sentido horario.   
   void rotar();
